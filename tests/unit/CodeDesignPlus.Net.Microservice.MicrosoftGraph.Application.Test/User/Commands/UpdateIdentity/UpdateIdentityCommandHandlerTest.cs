...
public class UpdateIdentityCommandHandlerTest
{
    ...
    {
        // Arrange
        var request = new UpdateIdentityCommand(Guid.NewGuid(), "Joe", "Doe", "Joe Doe", "joe.doe@fake.com", "3105631234", "1234567890", null, true);
        repositoryMock
    ...
    public async Task Handle_ValidRequest_UpdatesUserSuccessfully()
    {
        ...
        // Assert
        identityServerMock.Verify(i => i.UpdateUserAsync(user.IdentityProviderId, mappedUser, It.IsAny<CancellationToken>()), Times.Once);
    }
}
