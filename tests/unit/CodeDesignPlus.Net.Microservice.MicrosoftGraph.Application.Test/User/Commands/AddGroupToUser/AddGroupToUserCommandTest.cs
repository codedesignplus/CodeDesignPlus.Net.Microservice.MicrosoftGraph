...
public class AddGroupToUserCommandTest
{
    ...
    {
        // Arrange
        var command = new AddGroupToUserCommand(Guid.Empty, Guid.NewGuid());
    ...
    {
        // Arrange
        var command = new AddGroupToUserCommand(Guid.NewGuid(), Guid.Empty);
    ...
    {
        // Arrange
        var command = new AddGroupToUserCommand(Guid.NewGuid(), Guid.NewGuid());
