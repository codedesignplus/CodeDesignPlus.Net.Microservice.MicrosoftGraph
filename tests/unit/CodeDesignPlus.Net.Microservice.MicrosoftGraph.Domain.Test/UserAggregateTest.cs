...
public class UserAggregateTest
{
    ...
    public void Create_ValidId_ReturnsUserAggregate()
    {
        ...
        // Act
        var userAggregate = UserAggregate.Create(id, Guid.NewGuid(), Domain.Enums.IdentityProvider.MicrosoftEntraExternalId, "Joe", "Doe", "joee.doenew@fake.com", "3107545252", "Joe Doe", "1234567890", null, "key", "cipher", false, true);
    ...
    public void Create_InvalidId_ThrowsException()
    {
        ...
        // Act & Assert
        var exception = Assert.Throws<CodeDesignPlusException>(() => UserAggregate.Create(id, Guid.NewGuid(), Domain.Enums.IdentityProvider.MicrosoftEntraExternalId, "Joe", "Doe", "joee.doenew@fake.com", "3107545252", "Joe Doe", "1234567890", null, "key", "cipher", false, true));
